...
public class ConcessionnaireUserFactory implements IUserFactory {
    ...
    public Utilisateur createUser(RegisterRequest request, String encodedPassword) {
        Role role = roleRepository.findByLabelrole(RoleType.CONCESSIONNAIRE.name())
                .orElseThrow(() -> new RuntimeException("Rôle CONCESSIONNAIRE non trouvé"));
